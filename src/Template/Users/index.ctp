    ...
    <?php if (isset($breeders)): ?>
      ...
      <table width=100%>
        ...
        foreach ($breeders as $breeder):
          ...
          <td>
            <?=$this->Html->link('['.$breeder['id'].'] '.$breeder['name']. ' ('.(isset($breeder['cats'][0]) ? $breeder['cats'][0]['total'] : '') .')',
              array('plugin'=>'Kissagalleria','controller'=>'Cats','action' => 'index','breed' => $breeder->id)); ?>
          </td>
